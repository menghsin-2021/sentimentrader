...
# # for ssl certificate
# @app.route('/.well-known/pki-validation/<name>')
# def get_txt(name=None):
#     if name:
#         try:
#             return send_from_directory(ssl_txt_path, name)
#         except:
#             return 'The txt you request is not found'
#     return 'The txt you request is not found'
